...
class Admin::ProductsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_product" do
    assert_difference('Admin::Product.count') do
      post admin_products_url, params: { admin_product: { productCode: @admin_product.productCode, productCost: @admin_product.productCost, productName: @admin_product.productName } }
    end
  ...
  test "should update admin_product" do
    patch admin_product_url(@admin_product), params: { admin_product: { productCode: @admin_product.productCode, productCost: @admin_product.productCost, productName: @admin_product.productName } }
