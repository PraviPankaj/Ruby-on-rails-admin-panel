...
class Admin::CustomersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin_customer" do
    assert_difference('Admin::Customer.count') do
      post admin_customers_url, params: { admin_customer: { customerCode: @admin_customer.customerCode, customerName: @admin_customer.customerName, customerPhone: @admin_customer.customerPhone } }
    end
  ...
  test "should update admin_customer" do
    patch admin_customer_url(@admin_customer), params: { admin_customer: { customerCode: @admin_customer.customerCode, customerName: @admin_customer.customerName, customerPhone: @admin_customer.customerPhone } }
