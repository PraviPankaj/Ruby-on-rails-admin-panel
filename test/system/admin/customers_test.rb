...
class Admin::CustomersTest < ApplicationSystemTestCase
  ...
  test "creating a Customer" do
    ...
    fill_in "Customercode", with: @admin_customer.customerCode
    fill_in "Customername", with: @admin_customer.customerName
    fill_in "Customerphone", with: @admin_customer.customerPhone
